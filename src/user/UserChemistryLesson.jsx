...
const UserEnglishLesson = () => {
  ...
  const { UserChemistryFetch } = useContext(UserResponseContext);

  // Chemistry handel submit-------
  const navigate = useNavigate();
  const [loading, setLoading] = useState(false);
  const handelUserChemistryLesson = async (e) => {
    e.preventDefault();
    setLoading(true);
    await UserChemistryFetch();
    setLoading(false);
      ...
      <div className="container mx-auto mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="lesson-form">
            <form onSubmit={ handelUserChemistryLesson}>
              <div className="title text-center mt-3 mb-3">
                <h1>
                  < FcBiomass className="inline text-3xl me-2" />
                  Chemistry Lesson
                </h1>
              </div>
              ...
              <div className="col mt-8 mb-5 mx-8">
                <Button type="submit" color="blue" className="w-full">
                  <i className="fa-solid fa-paper-plane me-2"></i>Create Chemistry
                  Lesson
                </Button>
              </div>
            </form>
