...
const UserEnglishLesson = () => {
  ...
  const { UserPhysicsFetch } = useContext(UserResponseContext);

  // Physics handel submit-------
  const navigate = useNavigate();
  const [loading, setLoading] = useState(false);
  const handelUserPhysicsLesson = async (e) => {
    e.preventDefault();
    setLoading(true);
    await UserPhysicsFetch();
    setLoading(false);
        ...
        <div className="container mx-auto mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="lesson-form">
              <form onSubmit={handelUserPhysicsLesson}>
                <div className="title text-center mt-3 mb-3">
                  <h1>
                    <LuPencilRuler  className="inline text-purple-500 text-2xl me-2" />
                    Physics Lesson
                  </h1>
                </div>
