...
const UserEnglishLesson = () => {
  ...
  const { UserBiologyFetch } = useContext(UserResponseContext);

  // Biology handel submit-------
  const navigate = useNavigate();
  const [loading, setLoading] = useState(false);
  const handelUserBiologyLesson = async (e) => {
    e.preventDefault();
    setLoading(true);
    await UserBiologyFetch();
    setLoading(false);
        ...
        <div className="container mx-auto mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="lesson-form">
              <form onSubmit={handelUserBiologyLesson}>
                <div className="title text-center mt-3 mb-3">
                  <h1>
                    <FcBiotech className="inline text-lime-500 text-3xl me-2" />
                    Biology Lesson
                  </h1>
                </div>
